...
class MulOp(Op):
    ...
    def compute(self, node, input_vals):
        ...
        """TODO: Your code here"""
        return input_vals[0].multiply(input_vals[1])
...
class MulByConstOp(Op):
    ...
    def compute(self, node, input_vals):
        ...
        """TODO: Your code here"""
        return input_vals * node.const_attr
...
class MatMulOp(Op):
    ...
    def gradient(self, node, output_grad):
        ...
        """
        """TODO: Your code here"""
        return [output_grad.dot(node.inputs[1].T), node.inputs[0].T.dot(output_grad)]
...
def gradients(output_node, node_list):
    ...
    for node in reverse_topo_order:
        ...
        for i in len(node.inputs):
            if node.inputs[i] in node_to_output_grads_list:
                node_to_output_grads_list[node.inputs[i]].append(grads[i])
            else:
                node_to_output_grads_list[node.inputs[i]] = [grads[i]]
